          ...
          <div key={index} className="flex flex-col items-start">
            ...
            <div className="px-5 py-2">
                ...
                <div className="flex flex-row gap-2 py-2">
                    <span className="bg-[#c1d0bd] px-2 py-1 text-[#00492c] flex flex-row gap-1 items-center"><Image src={bedImage} alt="tub-image" className="size-5"/> {property.bedrooms} Beds </span>
                    <span className="bg-[#c1d0bd] px-2 py-1 text-[#00492c] flex flex-row gap-1 items-center"><Image src={tubImage} alt="tub-image" className="size-5"/> {property.bathrooms} Baths </span>
                    <span className="bg-[#c1d0bd] px-2 py-1 text-[#00492c] flex flex-row gap-1 items-center"><Image src={carImage} alt="car-image" className="size-5"/> {property.parkings} Cars </span>
                </div>
            </div>
          </div>
        ))}
