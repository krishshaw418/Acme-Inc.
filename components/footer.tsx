export default function Footer() {
    return (
        <footer className="bg-[#00492c] text-white p-6 md:p-12 lg:p-16" id="contact-us">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="order-1 lg:order-2 space-y-4 md:space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                            <span className="font-semibold text-sm md:text-base">PHONE</span>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                            ...
                            <span className="text-sm md:text-base break-all">hello@reallygreatsite.com</span>
                        </div>
                        
                        {/* Social */}
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                            <span className="font-semibold text-sm md:text-base">SOCIAL</span>
